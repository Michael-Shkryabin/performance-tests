...
make_purchase_operation_response = httpx.post(
    ...
    json=make_purchase_operation_pyload
)
...
print('Get operations receipt response:', get_operation_receipt_response_data)
print('Get operations receipt status code:', get_operation_receipt_response.status_code)